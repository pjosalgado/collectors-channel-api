...
def get_all():
    ...
    all_movies, is_last_page = get_data_paginated(
        all_movies, page, per_page, offset)
...
def find_in_db(service, key=None, value=None, sort=None, direction=None):
    ...
    print('find_in_db -> service = {}, key = {}, value = {}, sort = {}, direction = {}'.format(
        service, key, value, sort, direction), flush=True)
